...
public class ChoisirTulipe implements MouseListener {
    ...
    public ChoisirTulipe(Etat etat, VueJardin affichage) {
        this.etat = etat;
        this.affichage = affichage;
        this.typeFleur = Fleur.Type.TULIPE;
    ...
    public void mouseClicked(MouseEvent e) {
        System.out.println("ChoisirTulipe");
        SharedButtonGroup.setSelectedButton("ChoisirTulipe");
        SharedButtonGroup.isSelectedButton();
        VueJardinier.removeAllFleurListeners();
        VueBatiment.removeAllListenersBat();
        if (sharedButtonGroup.isTuplipe) {
